...
Void MenuState_obj::create( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(20)
		::flixel::text::FlxText tmp = ::flixel::text::FlxText_obj::__new((int)10,(int)10,(int)100,HX_HCSTRING("Hello, World!","\x15","\xc0","\x23","\x88"),null(),null());		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(20)
		this->add(tmp);
		HX_STACK_LINE(21)
		this->super::create();
...
{
		HX_STACK_FRAME("MenuState","destroy",0xf9ac905e,"MenuState.destroy","MenuState.hx",30,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(30)
		this->super::destroy();
	}
...
{
		HX_STACK_FRAME("MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",38,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(38)
		this->super::update();
	}
