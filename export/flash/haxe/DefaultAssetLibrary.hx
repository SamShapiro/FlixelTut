...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/haxe_tutorial.oep", __ASSET__assets_data_haxe_tutorial_oep);
		type.set ("assets/data/haxe_tutorial.oep", AssetType.TEXT);
		...
		id = "assets/data/haxe_tutorial.oep";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_haxe_tutorial_oep extends flash.utils.ByteArray { }
...
@:file("assets/data/haxe_tutorial.oep") #if display private #end class __ASSET__assets_data_haxe_tutorial_oep extends lime.utils.ByteArray {}
