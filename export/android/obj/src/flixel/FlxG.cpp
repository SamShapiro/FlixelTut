...
Void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
{
		...
		HX_STACK_LINE(459)
		::flixel::_system::frontEnds::InputFrontEnd tmp20 = ::flixel::FlxG_obj::inputs;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(459)
		::flixel::input::android::FlxAndroidKeys tmp21 = ::flixel::input::android::FlxAndroidKeys_obj::__new();		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(459)
		::flixel::input::android::FlxAndroidKeys tmp22 = tmp20->__Field(HX_HCSTRING("add_flixel_input_android_FlxAndroidKeys","\x5b","\x5d","\x92","\xe6"), hx::paccDynamic )(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(459)
		::flixel::FlxG_obj::android = tmp22;
		HX_STACK_LINE(463)
		::flixel::input::FlxAccelerometer tmp23 = ::flixel::input::FlxAccelerometer_obj::__new();		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(463)
		::flixel::FlxG_obj::accelerometer = tmp23;
		HX_STACK_LINE(465)
		::flixel::util::FlxSave tmp24 = ::flixel::FlxG_obj::save;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(465)
		tmp24->bind(HX_HCSTRING("flixel","\x5c","\x42","\x70","\x3d"));
		HX_STACK_LINE(468)
		::flixel::_system::frontEnds::SoundFrontEnd tmp25 = ::flixel::FlxG_obj::sound;		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(468)
		tmp25->__Field(HX_HCSTRING("loadSavedPrefs","\xef","\xed","\x3b","\x02"), hx::paccDynamic )();
	}
return null();
}
