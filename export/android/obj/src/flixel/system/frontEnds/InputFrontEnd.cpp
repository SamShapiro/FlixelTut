...
::flixel::input::android::FlxAndroidKeys InputFrontEnd_obj::add_flixel_input_android_FlxAndroidKeys( ::flixel::input::android::FlxAndroidKeys Input){
		...
		while((true)){
			...
			HX_STACK_LINE(30)
			{
				...
				HX_STACK_LINE(30)
				{
					...
					HX_STACK_LINE(30)
					::flixel::input::android::FlxAndroidKeys tmp5 = Input;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(30)
					...
					if ((tmp6)){
						...
						HX_STACK_LINE(30)
						::flixel::input::android::FlxAndroidKeys tmp7 = Input;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(30)
			...
			if ((tmp3)){
				HX_STACK_LINE(32)
				::flixel::input::android::FlxAndroidKeys tmp4 = Input;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(32)
				return tmp4;
			}
		}
	...
	HX_STACK_LINE(36)
	::flixel::input::android::FlxAndroidKeys tmp = Input;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(36)
	this->list->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp);
	HX_STACK_LINE(37)
	::flixel::input::android::FlxAndroidKeys tmp1 = Input;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(37)
	return tmp1;
}
