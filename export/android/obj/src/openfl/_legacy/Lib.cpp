	...
	HX_STACK_ARG(args,"args")
{
		...
		HX_STACK_LINE(210)
		::String tmp1 = library;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(210)
		::String tmp2 = method;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(210)
		int tmp3 = args;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(210)
		Dynamic tmp4 = ::cpp::Lib_obj::load(tmp1,tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(210)
		return tmp4;
		HX_STACK_LINE(213)
		::haxe::ds::StringMap tmp5 = ::openfl::_legacy::Lib_obj::__moduleNames;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(213)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(213)
			::openfl::_legacy::Lib_obj::__moduleNames = tmp7;
		}
		HX_STACK_LINE(214)
		::haxe::ds::StringMap tmp7 = ::openfl::_legacy::Lib_obj::__moduleNames;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(214)
		...
		if ((tmp9)){
			HX_STACK_LINE(217)
			::haxe::ds::StringMap tmp10 = ::openfl::_legacy::Lib_obj::__moduleNames;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(217)
			::String tmp11 = library;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(217)
			::String tmp12 = tmp10->get(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(217)
			::String tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(217)
			::String tmp14 = method;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(217)
			int tmp15 = args;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(217)
			Dynamic tmp16 = ::cpp::Lib_obj::load(tmp13,tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(217)
			return tmp16;
		}
		HX_STACK_LINE(234)
		...
		::String tmp11 = library;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(234)
		::String tmp12 = library;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(234)
		tmp10->set(tmp11,tmp12);
		HX_STACK_LINE(245)
		::String tmp13 = (HX_HCSTRING("./","\x41","\x28","\x00","\x00") + library);		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(245)
		::String tmp14 = library;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(245)
		::String tmp15 = method;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(245)
		int tmp16 = args;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(245)
		Dynamic tmp17 = ::openfl::_legacy::Lib_obj::tryLoad(tmp13,tmp14,tmp15,tmp16);		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(245)
		Dynamic result = tmp17;		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(248)
		bool tmp18 = (result == null());		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(248)
		if ((tmp18)){
			HX_STACK_LINE(250)
			::String tmp19 = (HX_HCSTRING(".\\","\x6e","\x28","\x00","\x00") + library);		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(250)
			::String tmp20 = library;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(250)
			::String tmp21 = method;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(250)
			int tmp22 = args;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(250)
			Dynamic tmp23 = ::openfl::_legacy::Lib_obj::tryLoad(tmp19,tmp20,tmp21,tmp22);		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(250)
			result = tmp23;
		}
		HX_STACK_LINE(254)
		...
		if ((tmp19)){
			...
			::String tmp20 = library;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(256)
			::String tmp21 = library;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(256)
			::String tmp22 = method;		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(256)
			int tmp23 = args;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(256)
			Dynamic tmp24 = ::openfl::_legacy::Lib_obj::tryLoad(tmp20,tmp21,tmp22,tmp23);		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(256)
			result = tmp24;
		}
		HX_STACK_LINE(260)
		...
		if ((tmp20)){
			HX_STACK_LINE(262)
			::String tmp21 = ::openfl::_legacy::Lib_obj::sysName();		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(262)
			::String tmp22 = tmp21.substr((int)7,null());		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(262)
			::String tmp23 = tmp22.toLowerCase();		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(262)
			bool tmp24 = (tmp23 == HX_HCSTRING("windows","\x83","\xde","\x74","\xe8"));		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(262)
			::String tmp25;		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(262)
			if ((tmp24)){
				HX_STACK_LINE(262)
				tmp25 = HX_HCSTRING("\\","\x5c","\x00","\x00","\x00");
			}
			else{
				HX_STACK_LINE(262)
				tmp25 = HX_HCSTRING("/","\x2f","\x00","\x00","\x00");
			}
			HX_STACK_LINE(262)
			::String slash = tmp25;		HX_STACK_VAR(slash,"slash");
			HX_STACK_LINE(263)
			::String tmp26 = ::openfl::_legacy::Lib_obj::findHaxeLib(HX_HCSTRING("lime","\x15","\x17","\xb3","\x47"));		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(263)
			::String haxelib = tmp26;		HX_STACK_VAR(haxelib,"haxelib");
			HX_STACK_LINE(265)
			bool tmp27 = (haxelib != HX_HCSTRING("","\x00","\x00","\x00","\x00"));		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(265)
			if ((tmp27)){
				HX_STACK_LINE(267)
				::String tmp28 = (haxelib + slash);		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(267)
				::String tmp29 = (tmp28 + HX_HCSTRING("legacy","\x49","\x7a","\x62","\x9a"));		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(267)
				::String tmp30 = slash;		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(267)
				::String tmp31 = (tmp29 + tmp30);		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(267)
				::String tmp32 = (tmp31 + HX_HCSTRING("ndll","\x36","\xb8","\x01","\x49"));		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(267)
				::String tmp33 = slash;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(267)
				::String tmp34 = (tmp32 + tmp33);		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(267)
				::String tmp35 = ::openfl::_legacy::Lib_obj::sysName();		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(267)
				::String tmp36 = (tmp34 + tmp35);		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(267)
				::String tmp37 = slash;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(267)
				::String tmp38 = (tmp36 + tmp37);		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(267)
				::String tmp39 = library;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(267)
				::String tmp40 = (tmp38 + tmp39);		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(267)
				::String tmp41 = library;		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(267)
				::String tmp42 = method;		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(267)
				int tmp43 = args;		HX_STACK_VAR(tmp43,"tmp43");
				HX_STACK_LINE(267)
				Dynamic tmp44 = ::openfl::_legacy::Lib_obj::tryLoad(tmp40,tmp41,tmp42,tmp43);		HX_STACK_VAR(tmp44,"tmp44");
				HX_STACK_LINE(267)
				result = tmp44;
				HX_STACK_LINE(269)
				bool tmp45 = (result == null());		HX_STACK_VAR(tmp45,"tmp45");
				HX_STACK_LINE(269)
				if ((tmp45)){
					HX_STACK_LINE(271)
					::String tmp46 = (haxelib + slash);		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(271)
					::String tmp47 = (tmp46 + HX_HCSTRING("legacy","\x49","\x7a","\x62","\x9a"));		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(271)
					::String tmp48 = slash;		HX_STACK_VAR(tmp48,"tmp48");
					HX_STACK_LINE(271)
					::String tmp49 = (tmp47 + tmp48);		HX_STACK_VAR(tmp49,"tmp49");
					HX_STACK_LINE(271)
					::String tmp50 = (tmp49 + HX_HCSTRING("ndll","\x36","\xb8","\x01","\x49"));		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(271)
					::String tmp51 = slash;		HX_STACK_VAR(tmp51,"tmp51");
					HX_STACK_LINE(271)
					::String tmp52 = (tmp50 + tmp51);		HX_STACK_VAR(tmp52,"tmp52");
					HX_STACK_LINE(271)
					::String tmp53 = ::openfl::_legacy::Lib_obj::sysName();		HX_STACK_VAR(tmp53,"tmp53");
					HX_STACK_LINE(271)
					::String tmp54 = (tmp52 + tmp53);		HX_STACK_VAR(tmp54,"tmp54");
					HX_STACK_LINE(271)
					::String tmp55 = (tmp54 + HX_HCSTRING("64","\x3e","\x2f","\x00","\x00"));		HX_STACK_VAR(tmp55,"tmp55");
					HX_STACK_LINE(271)
					::String tmp56 = slash;		HX_STACK_VAR(tmp56,"tmp56");
					HX_STACK_LINE(271)
					::String tmp57 = (tmp55 + tmp56);		HX_STACK_VAR(tmp57,"tmp57");
					HX_STACK_LINE(271)
					::String tmp58 = library;		HX_STACK_VAR(tmp58,"tmp58");
					HX_STACK_LINE(271)
					::String tmp59 = (tmp57 + tmp58);		HX_STACK_VAR(tmp59,"tmp59");
					HX_STACK_LINE(271)
					::String tmp60 = library;		HX_STACK_VAR(tmp60,"tmp60");
					HX_STACK_LINE(271)
					::String tmp61 = method;		HX_STACK_VAR(tmp61,"tmp61");
					HX_STACK_LINE(271)
					int tmp62 = args;		HX_STACK_VAR(tmp62,"tmp62");
					HX_STACK_LINE(271)
					Dynamic tmp63 = ::openfl::_legacy::Lib_obj::tryLoad(tmp59,tmp60,tmp61,tmp62);		HX_STACK_VAR(tmp63,"tmp63");
					HX_STACK_LINE(271)
					result = tmp63;
				}
			}
		...
		HX_STACK_LINE(279)
		Dynamic tmp21 = result;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(279)
		::String tmp22 = ::Std_obj::string(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(279)
		::String tmp23 = (HX_HCSTRING("Result : ","\xe9","\x19","\x2c","\x14") + tmp22);		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(279)
		::openfl::_legacy::Lib_obj::loaderTrace(tmp23);
		HX_STACK_LINE(289)
		Dynamic tmp24 = result;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(289)
		return tmp24;
	}
}
...
Void Lib_obj::rethrow( Dynamic error){
{
		...
		if ((tmp10)){
			...
			HX_STACK_LINE(360)
			::String tmp14 = message;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(360)
			Dynamic tmp15 = hx::SourceInfo(HX_HCSTRING("Lib.hx","\xb9","\x80","\x1c","\x19"),360,HX_HCSTRING("openfl._legacy.Lib","\xc1","\xa5","\x5c","\xfc"),HX_HCSTRING("rethrow","\x93","\xb0","\x2a","\xf6"));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(360)
...
Void Lib_obj::exit( ){
{
		...
		if ((tmp1)){
			HX_STACK_LINE(456)
			Dynamic tmp2 = quit;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(456)
			Dynamic tmp3 = ::openfl::_legacy::Lib_obj::close_dyn();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(456)
...
{
		HX_STACK_FRAME("openfl._legacy.Lib","postUICallback",0xf68580a6,"openfl._legacy.Lib.postUICallback","openfl/_legacy/Lib.hx",501,0x739f021f)
		HX_STACK_ARG(inCallback,"inCallback")
		HX_STACK_LINE(504)
		Dynamic tmp = inCallback;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(504)
		::openfl::_legacy::Lib_obj::lime_post_ui_callback(tmp);
	}
return null();
}
...
struct _Function_0_1{
	...
	lime_post_ui_callback= ::openfl::_legacy::Lib_obj::load(HX_HCSTRING("lime-legacy","\xc1","\x7f","\xb9","\x87"),HX_HCSTRING("lime_legacy_post_ui_callback","\x3d","\x6e","\x77","\xa3"),(int)1);
